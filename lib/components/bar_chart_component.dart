  ...
  BarChartGroupData makeGroupData(
    ...
    return BarChartGroupData(
      ...
      barRods: [
        BarChartRodData(
          toY: isTouched ? y + 1 : y,
          color: isTouched ? contentColorGreen : barColor,
          width: width,
          borderSide: isTouched
              ? const BorderSide(color: contentColorGreen)
              : const BorderSide(color: Colors.white, width: 0),
          backDrawRodData: BackgroundBarChartRodData(
            show: true,
            toY: 20,
            color: contentColorWhite.withOpacity(0.3),
          ),
        ),
      ],
              ...
              children: <TextSpan>[
                TextSpan(
                  ...
                  style: const TextStyle(
                    color: Colors.white, //widget.contentColorGreen,
                    fontSize: 16,
